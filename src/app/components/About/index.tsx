...
const AboutSection = () => {
	return (
		<section id='qui-suis-je' className='content-container content-container--inner'>
			...
			<p className='text-center font-light text-xl md:text-3xl px-4 xl:px-32 my-16'>Spécialisée en pédiatrie, j’accompagne les enfants tout au long de leur développement, de la naissance jusqu’aux études supérieures.</p>
